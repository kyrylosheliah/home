...
local highlight = {
  ...
  ["String"] = { fg = c.white }, -- a string constant: "this is a string"
  ["Character"] = { fg = c.blue }, -- a character constant: 'c', '\n'
  ["Number"] = { fg = c.white }, -- a number constant: 234, 0xff
  ["Boolean"] = { fg = c.white }, -- a boolean constant: TRUE, false
  ["Float"] = { fg = c.white }, -- a floating point constant: 2.3e10
  ...
  ["Conditional"] = { fg = c.white }, -- if, then, else, endif, switch, etc.
  ["Repeat"] = { fg = c.white }, -- for, do, while, etc.
  ["Label"] = { fg = c.white }, -- case, default, etc.
  ["Operator"] = { fg = c.white }, -- sizeof", "+", "*", etc.
  ["Keyword"] = { fg = c.white }, -- any other keyword
  ["Exception"] = { fg = c.white }, -- try, catch, throw
  ["PreProc"] = { fg = c.red }, -- generic Preprocessor
  ["Include"] = { fg = c.white }, -- preprocessor #include
  ...
  ["@constructor.javascript"] = { fg = c.white },
  ["@keyword.clojure"] = { fg = c.white },
  ...
  ["TelescopeResultsTitle"] = { fg = c.black, bg = c.white },
