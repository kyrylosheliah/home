...
return {
  ...
  config = function()
    ...
    lsp_zero.on_attach(function(client, bufnr)
      ...
      vim.keymap.set("n", "[d", vim.diagnostic.goto_prev, { desc = 'Go to previous [D]iagnostic message', buffer = bufnr, remap = false })
      vim.keymap.set("n", "]d", vim.diagnostic.goto_next, { desc = 'Go to next [D]iagnostic message', buffer = bufnr, remap = false }opts)
