...
-- Normal
local palette = {
  red = vs.regexp, --def.c["LightCoral"],
  mint = vs.literal,
  green = vs.comment, --def.c["LightGreen"],
  azure = vs.variable,
  blue = vs.keyword, --def.c["DeepSkyBlue"],
  yellow = vs.punctuation, --def.c["LightGoldenrod"],
  brown = vs.string, --def.c["Peru"],
  purple = vs.namespace, --def.c["LightMagenta"],
  cyan = vs.builtin, --shade(def.c["DarkSlateGray1"], 0.5, c.white),
}
...
local  highlight = {
  ["Comment"] = { fg = c.green }, -- any comment
  ["Constant"] = { fg = c.cyan }, -- any constant
  ["String"] = { fg = c.brown }, -- a string constant: "this is a string"
  ["Character"] = { fg = c.brown }, -- a character constant: 'c', '\n'
  ["Number"] = { fg = c.mint }, -- a number constant: 234, 0xff
  ["Boolean"] = { fg = c.mint }, -- a boolean constant: TRUE, false
  ["Float"] = { fg = c.mint }, -- a floating point constant: 2.3e10
  ["Identifier"] = { fg = c.azure }, -- any variable name
  ["Function"] = { fg = c.azure }, -- function name (also: methods for classes)
  ["Statement"] = { fg = c.azure }, -- any statement
