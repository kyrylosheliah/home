...
set("n", "<C-Up>", "<cmd>resize +1<cr>", { desc = "Increase Window Height" })
set("n", "<C-Down>", "<cmd>resize -1<cr>", { desc = "Decrease Window Height" })
set("n", "<C-Left>", "<cmd>vertical resize -1<cr>", { desc = "Decrease Window Width" })
set("n", "<C-Right>", "<cmd>vertical resize +1<cr>", { desc = "Increase Window Width" })
--[[
